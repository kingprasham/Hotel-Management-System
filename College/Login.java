...
public class Login extends JFrame implements ActionListener {
	...
	ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("College/icons/background.jpg"));
    ...
    ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("College/icons/login.jpg"));
